    ...
    <section id="layanan" class="py-20 bg-gradient-to-br from-pink-50 via-white to-green-50 scroll-mt-16">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="text-center mt-16">
                ...
                <a href="{{ url('/user/konseling/create') }}" class="inline-block bg-pink-500 text-white font-bold text-lg px-10 py-4 rounded-full hover:bg-pink-600 transition shadow-lg hover:shadow-xl">Mulai Konseling Sekarang</a>
            </div>
