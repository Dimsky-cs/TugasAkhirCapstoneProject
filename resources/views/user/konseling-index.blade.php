                                    ...
                                    <a href="{{ route('user.konseling.index', ['sort_by' => 'consultation_date', 'sort_direction' => request('sort_direction') == 'asc' ? 'desc' : 'asc', 'search' => request('search')]) }}"
                                        ...
                                        <span
                                            ...
                                            @if (request('sort_by') == 'consultation_date')
                                                ...
                                                @endif
                                            @else
                                                <!-- Panah Default (Transparan, muncul pas hover) -->
                                                <svg class="h-4 w-4 opacity-0 group-hover:opacity-50" fill="none"
                                                    stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="2"
                            ...
                            @foreach ($konselings as $k)
                                <tr>
                                    ...
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        ...
                                        <span class="text-xs text-gray-500">{{ ucfirst($k->service_type) }}</span>
                                    </td>
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <span
                                    ...
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        ...
                                        @if ($k->status == 'confirmed')
                                            ...
                                            @else
                                                <span class="text-xs text-gray-400 italic">Link belum ada</span>
                                            @endif
                                        @elseif($k->status == 'completed')
                                            @if (!$k->rating)
                                                <!-- Belum review: Tampilkan tombol -->
                                                <a href="{{ route('user.konseling.review', $k->id) }}"
                                                    class="inline-flex items-center px-3 py-1 bg-yellow-500 border border-transparent rounded-md font-semibold text-xs text-white tracking-widest hover:bg-yellow-600 transition ease-in-out duration-150">
                                                    ⭐ Beri Ulasan
                                                </a>
                                            @else
                                                ...
                                                <div class="flex flex-col">
                                                    ...
                                                    <span class="text-xs text-gray-500 italic">Terkirim</span>
                                                </div>
                                            @endif
                                        @else
