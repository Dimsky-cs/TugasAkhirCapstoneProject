    ...
    <div class="py-12 bg-gray-100 min-h-screen">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden p-8">
                ...
                <p class="text-gray-500 mb-8">Buat akun baru untuk Klien, Psikolog, atau Admin.</p>
                ...
                <form action="{{ route('admin.users.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <select name="role" id="role"
                                ...
                                <option value="user" @if (old('role') == 'user') selected @endif>User (Klien)
                                </option>
                                <option value="psikolog" @if (old('role') == 'psikolog') selected @endif>Psikolog
                                </option>
                    ...
                    <div id="specialties-container" class="mt-6 {{ old('role') == 'psikolog' ? '' : 'hidden' }}">
                            ...
                            @foreach ($specialtiesList as $specialty)
                                <label class="flex items-center">
                                    <input type="checkbox" name="specialties[]" value="{{ $specialty }}"
                                        @if (is_array(old('specialties')) && in_array($specialty, old('specialties'))) checked @endif
